...
namespace DartRad.Migrations
{
    ...
    [Migration("20231007063915_subscribers-update")]
    partial class subscribersupdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DartRad.Entities.AnswerSequence", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DartRad.Entities.Quiz", b =>
                {
                    ...
                    b.Property<string>("ClinicalScenario")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DartRad.Entities.Subscriber", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DartRad.Entities.SuperAdmin", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 10, 7, 11, 39, 15, 0, DateTimeKind.Local).AddTicks(5754),
                            Email = "info@somuchheart.com",
                            Name = "Test Super Editor",
                            Password = "AQAAAAEAACcQAAAAEAB91hacCtytCEyXortCo8PSMA/hZcj2urKUTHprThHvf531nhp5TzsyzAtiOXUJ7A=="
                        });
                });
            ...
            modelBuilder.Entity("DartRad.Entities.Subscriber", b =>
                {
                    b.HasOne("DartRad.Entities.Editor", "CreatedByEditor")
                        .WithMany()
                        .HasForeignKey("CreatedBy");

                    b.Navigation("CreatedByEditor");
                });
